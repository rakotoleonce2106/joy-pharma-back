    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        foreach ($systemPaths as $systemPath) {
            ...
            $configuredMenus = $this->loadNavigationYaml(
                $container,
                $configuredMenus,
                $container->getParameter($systemPath) . '/config/navigation.yaml'
            );
        }
        ...
        foreach ($bundles as $bundle) {
            try {
                ...
                $configuredMenus = $this->loadNavigationYaml(
                    $container,
                    $configuredMenus,
                    dirname($reflection->getFileName()) . '/Resources/config/navigation.yaml'
                );
        ...
        // The Last argument of this service is always the menu configuration
        $container
