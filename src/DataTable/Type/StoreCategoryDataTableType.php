...
class StoreCategoryDataTableType extends AbstractDataTableType
{
    ...
    public function buildDataTable(DataTableBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addAction('create', LinkActionType::class, [
            'label' => 'storeCategory.datatable.create_new',
            'href' => $this->urlGenerator->generate('admin_store_category_new'),
            'attr' => [
                'variant' => 'default',
        ...
        // Filters
        $builder
            ->addFilter('id', StringFilterType::class, ['label' => 'storeCategory.datatable.id'])
            ->addFilter('label', StringFilterType::class, ['label' => 'storeCategory.datatable.label']);

        // Columns
        $builder
            ->addColumn('id', TextColumnType::class, [
                'label' => 'storeCategory.datatable.id',
                'sort' => true,
                'value_attr' => [
            ...
            ->addColumn('label', TextColumnType::class, [
                'label' => 'storeCategory.datatable.label',
                'sort' => true,
                'value_attr' => [
                    'class' => 'px-4'
                ]
       ...
       ;
        ...
        $builder
            ->addRowAction('edit', LinkActionType::class, [
                ...
                'href' => fn(StoreCategory $StoreCategory) => $this->urlGenerator->generate('admin_store_category_edit', ['id' => $StoreCategory->getId()]),
                'attr' => [
                    'size' => 'sm',
                    'variant' => 'outline',
                    'data-turbo-frame' => 'dialog',
            ...
            ->addRowAction('delete', FormActionType::class, [
                ...
                'action' => fn(StoreCategory $StoreCategory) => $this->urlGenerator->generate('admin_store_category_delete', ['id' => $StoreCategory->getId()]),
                'confirmation' => [
                    'type' => 'danger',
        ...
        $builder
            ->addBatchAction('delete', FormActionType::class, [
                ...
                'action' => $this->urlGenerator->generate('admin_store_category_batch_delete'),
                'confirmation' => [
                    'type' => 'danger',
