...
class FormDataTableType extends AbstractDataTableType
{
    ...
    public function buildDataTable(DataTableBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addAction('create', LinkActionType::class, [
            'label' => 'form.datatable.create_new',
            'href' => $this->urlGenerator->generate('admin_form_new'),
            'attr' => [
                'variant' => 'default',
        ...
        // Filters
        $builder
            ->addFilter('id', StringFilterType::class, ['label' => 'form.datatable.id'])
            ->addFilter('label', StringFilterType::class, ['label' => 'form.datatable.label']);

        // Columns
        $builder
            ->addColumn('id', TextColumnType::class, [
                'label' => 'form.datatable.id',
                'sort' => true,
                'value_attr' => [
        ...
        $builder
            ->addRowAction('edit', LinkActionType::class, [
                ...
                'href' => fn (Form $form) => $this->urlGenerator->generate('admin_form_edit', ['id' => $form->getId()]),
                'attr' => [
                    'size' => 'sm',
                    'variant' => 'outline',
                    'data-turbo-frame' => 'dialog',
            ...
            ->addRowAction('delete', FormActionType::class, [
                ...
                'action' => fn (Form $form) => $this->urlGenerator->generate('admin_form_delete', ['id' => $form->getId()]),
                'confirmation' => [
                    'type' => 'danger',
        ...
        $builder
            ->addBatchAction('delete', FormActionType::class, [
                ...
                'action' => $this->urlGenerator->generate('admin_form_batch_delete'),
                'confirmation' => [
                    'type' => 'danger',
    ...
    private function handleSearchFilter(DoctrineOrmProxyQuery $query, string $search): void
    {
        ...
        $criteria = $query->expr()->orX(
            $query->expr()->like("LOWER($alias.label)", ":$alias$parameter"),
        );
