...
class UnitDataTableType extends AbstractDataTableType
{
    ...
    public function buildDataTable(DataTableBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addAction('create', LinkActionType::class, [
            'label' => 'unit.datatable.create_new',
            'href' => $this->urlGenerator->generate('admin_unit_new'),
            'attr' => [
                'variant' => 'default',
        ...
        // Filters
        $builder
            ->addFilter('id', StringFilterType::class, ['label' => 'unit.datatable.id'])
            ->addFilter('label', StringFilterType::class, ['label' => 'unit.datatable.label']);

        // Columns
        $builder
            ->addColumn('id', TextColumnType::class, [
                'label' => 'unit.datatable.id',
                'sort' => true,
                'value_attr' => [
        ...
        $builder
            ->addRowAction('edit', LinkActionType::class, [
                ...
                'href' => fn (Unit $unit) => $this->urlGenerator->generate('admin_unit_edit', ['id' => $unit->getId()]),
                'attr' => [
                    'size' => 'sm',
                    'variant' => 'outline',
                    'data-turbo-frame' => 'dialog',
            ...
            ->addRowAction('delete', FormActionType::class, [
                ...
                'action' => fn (Unit $unit) => $this->urlGenerator->generate('admin_unit_delete', ['id' => $unit->getId()]),
                'confirmation' => [
                    'type' => 'danger',
        ...
        $builder
            ->addBatchAction('delete', FormActionType::class, [
                ...
                'action' => $this->urlGenerator->generate('admin_unit_batch_delete'),
                'confirmation' => [
                    'type' => 'danger',
