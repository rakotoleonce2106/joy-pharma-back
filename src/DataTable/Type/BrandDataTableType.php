...
class BrandDataTableType extends AbstractDataTableType
{
    ...
    public function buildDataTable(DataTableBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addAction('create', LinkActionType::class, [
            'label' => 'brand.datatable.create_new',
            'href' => $this->urlGenerator->generate('admin_brand_new'),
            'attr' => [
                'variant' => 'default',
        ...
        // Filters
        $builder
            ->addFilter('id', StringFilterType::class, ['label' => 'brand.datatable.id'])
            ->addFilter('name', StringFilterType::class, ['label' => 'brand.datatable.name']);

        // Columns
        $builder
            ->addColumn('id', TextColumnType::class, [
                'label' => 'brand.datatable.id',
                'sort' => true,
                'value_attr' => [
        ...
        $builder
            ->addRowAction('edit', LinkActionType::class, [
                ...
                'href' => fn (Brand $brand) => $this->urlGenerator->generate('admin_brand_edit', ['id' => $brand->getId()]),
                'attr' => [
                    'size' => 'sm',
                    'variant' => 'outline',
                    'data-turbo-frame' => '_top',
            ...
            ->addRowAction('delete', FormActionType::class, [
                ...
                'action' => fn (Brand $brand) => $this->urlGenerator->generate('admin_brand_delete', ['id' => $brand->getId()]),
                'confirmation' => [
                    'type' => 'danger',
